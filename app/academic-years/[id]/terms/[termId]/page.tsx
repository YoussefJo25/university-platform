  ...
  return (
    <div className="flex flex-1 flex-col">
      <section className="bg-gradient-to-l from-navy to-turquoise px-4 py-14 text-center sm:px-6">
        {term.years && (
          <p className="text-xs font-medium text-white/70 sm:text-sm">{term.years.name}</p>
        )}
        <h1 className="mt-2 text-2xl font-extrabold text-white sm:text-4xl">{term.name}</h1>
        <p className="mt-3 text-sm text-white/90 sm:text-base">المواد الدراسية الخاصة بهذا الترم</p>
      </section>
